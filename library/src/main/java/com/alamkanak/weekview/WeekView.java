...
public class WeekView extends View {
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE M/dd", Locale.getDefault()) : new SimpleDateFormat("EEE dd/M", Locale.getDefault());
    ...
    //+ nikeu
    public void reDrawWeekView(){
        invalidate();
    }

    public void loadEvents(List<? extends WeekViewEvent> eventsToLoad){

        mEventRects.clear();
        sortAndCacheEvents(eventsToLoad);
